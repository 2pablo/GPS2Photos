...
class PelIfd implements \IteratorAggregate, \ArrayAccess {
	...
	private const VALID_TAGS = array(
		self::IFD0                  => array(
			PelTag::IMAGE_WIDTH,
			PelTag::IMAGE_LENGTH,
		...
		self::EXIF                  => array(
			...
			PelTag::OECF,
			PelTag::INTERLACE, // Added for compatibility with EXIF Specification 2.3.
			PelTag::TIME_ZONE_OFFSET, // Added for compatibility with EXIF Specification 2.3.
			PelTag::SELF_TIMER_MODE, // Added for compatibility with EXIF Specification 2.3.
			PelTag::SENSITIVITY_TYPE, // Added for compatibility with EXIF Specification 2.3.
			PelTag::STANDARD_OUTPUT_SENSITIVITY, // Added for compatibility with EXIF Specification 2.3.
			PelTag::RECOMMENDED_EXPOSURE_INDEX, // Added for compatibility with EXIF Specification 2.3.
			PelTag::ISO_SPEED, // Added for compatibility with EXIF Specification 2.3.
			PelTag::ISO_SPEED_LATITUDE_YYY, // Added for compatibility with EXIF Specification 2.3.
			PelTag::ISO_SPEED_LATITUDE_ZZZ, // Added for compatibility with EXIF Specification 2.3.
			PelTag::EXIF_VERSION,
			...
			PelTag::CAMERA_OWNER_NAME, // Added for compatibility with EXIF Specification 2.3.
			PelTag::BODY_SERIAL_NUMBER, // Added for compatibility with EXIF Specification 2.3.
			PelTag::LENS_SPECIFICATION, // Added for compatibility with EXIF Specification 2.3.
		...
		self::GPS                   => array(
			...
			PelTag::GPS_H_POSITIONING_ERROR, // Added for compatibility with EXIF Specification 2.3.
		),
		self::INTEROPERABILITY      => array(
		...
		self::CANON_CAMERA_SETTINGS => array(
	...
	private function checkIfLoadingFinished() {
		if ( $this->type == self::IFD0 && isset( $this->sub[ self::EXIF ] ) ) {
			// Get MakerNotes from EXIF IFD and check if they are set
			$mk = $this->sub[ self::EXIF ]->getMakerNotes();
			if ( ! empty( $mk ) ) {
