 ...
 * @since      1.0.0
 * @since      1.0.1 Amended functions: gps2photos_plugin_admin_scripts(), gps2photos_add_page(), gps2photos_options_init().
 *
 ...
 *
 * @since 1.0.0
 * @since 1.0.1 Added inline style for admin page menu icon.
 */
