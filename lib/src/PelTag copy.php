...
class PelTag {
	 ...
	 * Components: 1.
	 */
	const STANDARD_OUTPUT_SENSITIVITY = 0x8831;
	 ...
	 * Components: 1.
	 */
	const RECOMMENDED_EXPOSURE_INDEX = 0x8832;
	 ...
	 * Components: 1.
	 */
	const ISO_SPEED_LATITUDE_YYY = 0x8834;
	 ...
	 * Components: 1.
	 */
	const ISO_SPEED_LATITUDE_ZZZ = 0x8835;
 ...
 * Added for GPS 2 PHOTOS WordPress Plugin
	 ...
	 * Components: Any.
	 */
	const CAMERA_OWNER_NAME = 0xA430;
	 ...
	 * Components: Any.
	 */
	const BODY_SERIAL_NUMBER = 0xA431;
	 ...
	 * Components: 4.
	 */
	const LENS_SPECIFICATION = 0xA432;
	...
	/**
	 * GPS horizontal positioning error in meters.
	 * Added for GPS 2 PHOTOS WordPress Plugin
	 * for compatibility with EXIF SPECIFICATION 2.3
	 *
	 * Format: {@link PelFormat::RATIONAL}.
	 ...
	 * Components: 1.
	 */
	const GPS_H_POSITIONING_ERROR = 0x001E;
	...
	protected static $exifTagsShort = array(
		...
		self::TIME_ZONE_OFFSET               => 'TimeZoneOffset',
		self::SELF_TIMER_MODE                => 'SelfTimerMode',
		self::SENSITIVITY_TYPE               => 'SensitivityType',
		self::STANDARD_OUTPUT_SENSITIVITY    => 'StandardOutputSensitivity',
		self::RECOMMENDED_EXPOSURE_INDEX     => 'RecommendedExposureIndex',
		self::ISO_SPEED                      => 'ISOSpeed',
		self::ISO_SPEED_LATITUDE_YYY         => 'ISOSpeedLatitudeYYY',
		self::ISO_SPEED_LATITUDE_ZZZ         => 'ISOSpeedLatitudeZZZ',
		...
		self::CAMERA_OWNER_NAME              => 'CameraOwnerName',
		self::BODY_SERIAL_NUMBER             => 'BodySerialNumber',
		self::LENS_SPECIFICATION             => 'LensSpecification',
	...
	protected static $exifTagsTitle = array(
		...
		self::OECF                           => 'OECF',
		self::INTERLACE                      => 'Interlace',
		self::TIME_ZONE_OFFSET               => 'Time Zone Offset',
		self::SELF_TIMER_MODE                => 'Self Timer Mode',
		self::SENSITIVITY_TYPE               => 'Sensitivity Type',
		self::STANDARD_OUTPUT_SENSITIVITY    => 'Standard Output Sensitivity',
		self::RECOMMENDED_EXPOSURE_INDEX     => 'Recommended Exposure Index',
		self::ISO_SPEED                      => 'ISO Speed',
		self::ISO_SPEED_LATITUDE_YYY         => 'ISO Speed Latitude YYY',
		self::ISO_SPEED_LATITUDE_ZZZ         => 'ISO Speed Latitude ZZZ',
		...
		self::CAMERA_OWNER_NAME              => 'Camera Owner Name',
		self::BODY_SERIAL_NUMBER             => 'Body Serial Number',
		self::LENS_SPECIFICATION             => 'Lens Specification',
	...
	protected static $gpsTagsShort = array(
		...
		self::GPS_H_POSITIONING_ERROR => 'GPSHPositioningError',
	);
