...
class PelEntrySShort extends PelEntryNumber {
	...
	private const TRANSLATIONS = array(
		PelIfd::CANON_FILE_INFO       => array(
			PelTag::CANON_FI_BRACKET_MODE        => array(
				0 => 'Off',
				1 => 'AEB',
				2 => 'FEB',
				3 => 'ISO',
			...
			PelTag::CANON_FI_RAW_JPG_QUALITY     => array(
				1   => 'Economy',
				2   => 'Normal',
				3   => 'Fine',
				4   => 'RAW',
			...
			PelTag::CANON_FI_RAW_JPG_SIZE        => array(
				0   => 'Large',
				1   => 'Medium',
				2   => 'Small',
				5   => 'Medium 1',
			...
			PelTag::CANON_FI_NOISE_REDUCTION     => array(
				0 => 'Off',
				1 => 'On (1D)',
				3 => 'On',
				4 => 'Auto',
			),
			PelTag::CANON_FI_WB_BRACKET_MODE     => array(
				0 => 'Off',
				1 => 'On (shift AB)',
				2 => 'On (shift GM)',
			),
			PelTag::CANON_FI_FILTER_EFFECT       => array(
				0 => 'None',
				1 => 'Yellow',
				2 => 'Orange',
				3 => 'Red',
			...
			PelTag::CANON_FI_TONING_EFFECT       => array(
				0 => 'None',
				1 => 'Sepia',
				2 => 'Blue',
				3 => 'Purple',
			...
			PelTag::CANON_FI_LIVE_VIEW_SHOOTING  => array(
				0 => 'Off',
				1 => 'On',
			),
			PelTag::CANON_FI_FLASH_EXPOSURE_LOCK => array(
				0 => 'Off',
				1 => 'On',
			),
		),
		PelIfd::CANON_CAMERA_SETTINGS => array(
			PelTag::CANON_CS_MACRO               => array(
				1 => 'Macro',
				2 => 'Normal',
			),
			PelTag::CANON_CS_QUALITY             => array(
				1   => 'Economy',
				2   => 'Normal',
				3   => 'Fine',
				4   => 'RAW',
			...
			PelTag::CANON_CS_FLASH_MODE          => array(
				0  => 'Off',
				1  => 'Auto',
				2  => 'On',
				3  => 'Red-eye reduction',
			...
			PelTag::CANON_CS_DRIVE_MODE          => array(
				0  => 'Single',
				1  => 'Continuous',
				2  => 'Movie',
			...
			PelTag::CANON_CS_FOCUS_MODE          => array(
				0   => 'One-shot AF',
				1   => 'AI Servo AF',
				2   => 'AI Focus AF',
				3   => 'Manual Focus (3)',
			...
			PelTag::CANON_CS_RECORD_MODE         => array(
				1  => 'JPEG',
				2  => 'CRW+THM',
				3  => 'AVI+THM',
				4  => 'TIF',
			...
			PelTag::CANON_CS_IMAGE_SIZE          => array(
				0   => 'Large',
				1   => 'Medium',
				2   => 'Small',
				5   => 'Medium 1',
			...
			PelTag::CANON_CS_EASY_MODE           => array(
				0   => 'Full auto',
				1   => 'Manual',
				2   => 'Landscape',
				3   => 'Fast shutter',
			...
			PelTag::CANON_CS_DIGITAL_ZOOM        => array(
				0 => 'None',
				1 => '2x',
				2 => '4x',
				3 => 'Other',
			),
			PelTag::CANON_CS_CONTRAST            => array(
				0 => 'Normal',
			),
			PelTag::CANON_CS_SATURATION          => array(
				0 => 'Normal',
			),
			PelTag::CANON_CS_METERING_MODE       => array(
				0 => 'Default',
				1 => 'Spot',
				2 => 'Average',
				3 => 'Evaluative',
			...
			PelTag::CANON_CS_FOCUS_TYPE          => array(
				0  => 'Manual',
				1  => 'Auto',
				2  => 'Not Known',
				3  => 'Macro',
			...
			PelTag::CANON_CS_AF_POINT            => array(
			...
			PelTag::CANON_CS_EXPOSURE_PROGRAM    => array(
				0 => 'Easy',
				1 => 'Program AE',
			...
			PelTag::CANON_CS_LENS_TYPE           => array(
			...
			PelTag::CANON_CS_FOCUS_CONTINUOUS    => array(
				0 => 'Single',
				1 => 'Continuous',
				8 => 'Manual',
			),
			PelTag::CANON_CS_AE_SETTING          => array(
				0 => 'Normal AE',
			...
			PelTag::CANON_CS_IMAGE_STABILIZATION => array(
				0   => 'Off',
				1   => 'On',
				2   => 'Shoot Only',
				3   => 'Panning',
			...
			PelTag::CANON_CS_SPOT_METERING_MODE  => array(
				0 => 'Center',
				1 => 'AF Point',
			),
			PelTag::CANON_CS_PHOTO_EFFECT        => array(
				0   => 'Off',
				1   => 'Vivid',
				2   => 'Neutral',
				3   => 'Smooth',
			...
			PelTag::CANON_CS_MANUAL_FLASH_OUTPUT => array(
				0x500 => 'Full',
				0x502 => 'Medium',
				0x504 => 'Low',
			),
			PelTag::CANON_CS_COLOR_TONE          => array(
				0 => 'Normal',
			),
			PelTag::CANON_CS_SRAW_QUALITY        => array(
				1 => 'sRAW1 (mRAW)',
				2 => 'sRAW2 (sRAW)',
			),
		),
