...
class PelEntryShort extends PelEntryNumber {
	...
	private const IFD_TYPE_TRANSLATIONS = array(
		PelIfd::CANON_SHOT_INFO => array(
			PelTag::CANON_SI_WHITE_BALANCE            => array(
				0  => 'Auto',
				1  => 'Daylight',
				2  => 'Cloudy',
				3  => 'Tungsten',
			...
			PelTag::CANON_SI_SLOW_SHUTTER             => array(
				0 => 'Off',
				1 => 'Night Scene',
				2 => 'On',
				3 => 'None',
			),
			PelTag::CANON_SI_AF_POINT_USED            => array(
				0x3000 => 'None (MF)',
				0x3001 => 'Right',
				0x3002 => 'Center',
				0x3003 => 'Center+Right',
			...
			PelTag::CANON_SI_AUTO_EXPOSURE_BRACKETING => array(
				- 1 => 'On',
				0   => 'Off',
				1   => 'On (shot 1)',
				2   => 'On (shot 2)',
			...
			PelTag::CANON_SI_CAMERA_TYPE              => array(
				248 => 'EOS High-end',
				250 => 'Compact',
				252 => 'EOS Mid-range',
				255 => 'DV Camera',
			),
			PelTag::CANON_SI_AUTO_ROTATE              => array(
				0 => 'None',
				1 => 'Rotate 90 CW',
				2 => 'Rotate 180',
				3 => 'Rotate 270 CW',
			),
			PelTag::CANON_SI_ND_FILTER                => array(
				0 => 'Off',
				1 => 'On',
			),
		),
		PelIfd::CANON_PANORAMA  => array(
			PelTag::CANON_PA_PANORAMA_DIRECTION => array(
				0 => 'Left to Right',
				1 => 'Right to Left',
				2 => 'Bottom to Top',
				3 => 'Top to Bottom',
	...
	private const PEL_TAG_TRANSLATIONS = array(
		PelTag::METERING_MODE               => array(
			0   => 'Unknown',
			1   => 'Average',
		...
		PelTag::COMPRESSION                 => array(
			1 => 'Uncompressed',
			6 => 'JPEG compression',
		),
		PelTag::PLANAR_CONFIGURATION        => array(
			1 => 'chunky format',
			2 => 'planar format',
		),
		PelTag::SENSING_METHOD              => array(
			1 => 'Not defined',
		...
		PelTag::FOCAL_PLANE_RESOLUTION_UNIT => array(
			2 => 'Inch',
			3 => 'Centimeter',
		),
		PelTag::RESOLUTION_UNIT             => array(
			2 => 'Inch',
			3 => 'Centimeter',
		),
		PelTag::EXPOSURE_PROGRAM            => array(
			0 => 'Not defined',
			1 => 'Manual',
			2 => 'Normal program',
			3 => 'Aperture priority',
		...
		PelTag::YCBCR_POSITIONING           => array(
			1 => 'centered',
			2 => 'co-sited',
		),
		PelTag::PHOTOMETRIC_INTERPRETATION  => array(
			2 => 'RGB',
			6 => 'YCbCr',
		),
		PelTag::COLOR_SPACE                 => array(
			1      => 'sRGB',
			2      => 'Adobe RGB',
			0xffff => 'Uncalibrated',
		),
		...
		PelTag::CUSTOM_RENDERED             => array(
			0 => 'Normal process',
			1 => 'Custom process',
		),
		PelTag::EXPOSURE_MODE               => array(
			0 => 'Auto exposure',
			1 => 'Manual exposure',
			2 => 'Auto bracket',
		),
		PelTag::WHITE_BALANCE               => array(
			0 => 'Auto white balance',
			1 => 'Manual white balance',
		),
		PelTag::SCENE_CAPTURE_TYPE          => array(
			0 => 'Standard',
			1 => 'Landscape',
			2 => 'Portrait',
			3 => 'Night scene',
		),
		PelTag::GAIN_CONTROL                => array(
			0 => 'Normal',
			1 => 'Low gain up',
			2 => 'High gain up',
			3 => 'Low gain down',
		...
		PelTag::SATURATION                  => array(
			0 => 'Normal',
			1 => 'Low saturation',
			2 => 'High saturation',
		),
		PelTag::CONTRAST                    => array(
			0 => 'Normal',
			1 => 'Soft',
			2 => 'Hard',
		),
		PelTag::SHARPNESS                   => array(
			0 => 'Normal',
			1 => 'Soft',
			2 => 'Hard',
		),
		PelTag::SUBJECT_DISTANCE_RANGE      => array(
			0 => 'Unknown',
			1 => 'Macro',
			2 => 'Close view',
			3 => 'Distant view',
